                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="password" name="pwd" id="pwd" title="비밀번호 변경" class="inp w100" />
                            <span class="tbltxt">
                                · 비밀번호 변경시에만 입력<br />
                                · 최소 5자~최대 50자 까지 입력
                            </span>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="pwd2" class="sound_only_ele">비밀번호 변경 확인</label>
                            <input type="password" name="pwd2" id="pwd2" title="변경할 비밀번호 확인" class="inp w100" />
                            <span class="tbltxt">
            ...
            <table class="table_wrt">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <label for="pwd" class="sound_only_ele">기존 비밀번호</label>
                            <input type="password" name="current_pwd" id="current_pwd" title="기존 비밀번호" class="inp w100" required />
                            <span class="tbltxt">
                                · 회원정보 변경을 위해 기존 비밀번호를 입력
                            </span>
                        </td>
                    </tr>
                </tbody>
