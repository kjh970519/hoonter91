        ...
        <table class="table1">
            ...
            <tbody>
                ...
                <tr>
                    <th>노출 기간</th>
                    <td>
                        <input type="text" name="show_from" class="inp" title="배너 노출 시작일" value="<?php echo $write['show_from']; ?>" datepicker />
                        &nbsp;&nbsp;부터&nbsp;&nbsp;
                        <input type="text" name="show_to" class="inp" title="배너 노출 종료일" value="<?php echo $write['show_to']; ?>" datepicker />
                        &nbsp;&nbsp;까지&nbsp;&nbsp;
                    </td>
                </tr>
            </tbody>
