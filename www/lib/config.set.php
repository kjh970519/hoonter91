...
define('REGEXP_IPV4', "/^(25[0-5]|2[0-4][0-9]|1?[0-9][0-9]?|\*)\.(25[0-5]|2[0-4][0-9]|1?[0-9][0-9]?|\*)\.(25[0-5]|2[0-4][0-9]|1?[0-9][0-9]?|\*)\.(25[0-5]|2[0-4][0-9]|1?[0-9][0-9]?|\*)$/"); // 이미지 추출
define('REGEXP_IPV6', "/^(([0-9a-fA-F]{1,4}):){7}([0-9a-fA-F]{1,4})$/"); // 이미지 추출
...
define('SET_INTDICT_TAGS', preg_replace("/\s+/", "", 'script, iframe, link, meta, embed, object, svg')); // 사용 금지 태그
