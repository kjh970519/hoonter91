                ...
                <tr>
                    ...
                    <td>
                        <select name="use_file2" class="inp">
                            <?php for ($i = 1; $i <= 10; $i++) { ; ?>
                            <option value="<?php echo $i; ?>" <?php if ($i==$write['use_file2']) { echo "selected"; }; ?>><?php echo $i; ?>개 첨부 가능</option>
                            <?php } ; ?>
                        </select>
                    </td>
                </tr>
        ...
        <table class="table1">
            ...
            <tbody>
                ...
                <tr>
                    <th>NEW 아이콘 설정</th>
                    <td>
                        <input type="text" name="ico_new_case" class="inp" title="NEW 아이콘 설정" value="<?php echo $write['ico_new_case']; ?>" /> 분
